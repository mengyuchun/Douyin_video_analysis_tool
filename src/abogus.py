"""A-Bogus 签名生成模块 - 移植自 TikTokDownloader (JoeanAmier)"""
...
class ABogus:
    ...
    def __init__(self, user_agent: str = USERAGENT, platform: str = None):
        self.chunk = []
        self.size = 0
        self.reg = self.__reg[:]
    ...
    def generate_string_2(self, url_params, method="GET", start_time=0, end_time=0) -> str:
    ...
    def generate_string_2_list(self, url_params, method="GET", start_time=0, end_time=0) -> list:
    ...
    def generate_result_end(cls, s, e="s4"):
        b = ord(s[120]) << 16
        return cls.__str[e][(b & 16515072) >> 18] + cls.__str[e][(b & 258048) >> 12] + "=="
    ...
    def generate_method_code(self, method="GET") -> list:
    ...
    @classmethod
    def sm3_to_array(cls, data) -> list:
    ...
    @classmethod
    def generate_browser_info(cls, platform="Win32") -> str:
